               ...
               duration-150 ease-in-out sm:text-sm sm:leading-9"
                ...
                <div className="mt-6">
                  <span className="block w-full rounded-md shadow-sm">
                    <button
                      className="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-500 transition duration-300 ease-in-out hover:bg-gray-600"
                      type="submit"
                    >
                      Sign in
                    </button>
                ...
                <p class=" text-sm mt-5 text-gray-100">Don&#x27;t have an account yet?
                    <a href="#!"
                         className="font-medium ml-3 text-blue-500 hover:text-blue-500 focus:outline-none focus:underline transition ease-in-out duration-150"         
