  ...
  return (
    <div ref={modalRef}
      ...
      <div className='mt-10 flex flex-col gap-5'>
        ...
        <div className=' bg-gray-900 rounded-xl px-20 py-6 flex flex-col gap-2 items-center mx-4'>
          <button
            onClick={onClose}
            className='place-self-end text-white'><X size={30} /></button>
          <div className="sm:mx-auto sm:w-full sm:max-w-md">

            <h2 className="mt-2 text-center text-3xl leading-9 font-extrabold  text-gray-200">
              Create an account
            </h2>
          </div>

          <div className="mt sm:mx-auto sm:w-full sm:max-w-md">
            <div className="bg-gray-900 py-8 px-4 w-18 shadow lg:rounded-md sm:rounded-lg sm:px-10">
              <form>
                ...
                <div className="mt-">
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    <input
                      className="text-black appearance-none block w-full lg:w-80 px-3 py-2 border
                ...
                duration-150 ease-in-out sm:text-sm sm:leading-9"
                      defaultValue=""
                      id="name"
                      name="Fullname"
                      ...
                      type="name"
                    />
                    <div className="hidden-flex  absolute inset-y-0 right-0 pr-3 items-center pointer-events-none">
      ...
      >
        Privacy Policy
                      ...
                      {/* {' '}and{' '} */}
                      <a
                        className="text-primary-600 text-gray-100 hover:text-primary-700"
                        href="/terms"
                        target="_blank"
                      >
                ...
                <div className="mt-4">
                  <span className="block w-full rounded-md shadow-sm">
                    <button
                      className="w-full lg:w-80 flex justify-center py-2 px-4 border
                       border-transparent text-sm font-medium rounded-md text-white bg-blue-500
                  ...
                  <p class="mt-4  text-sm leading-5 text-gray-300 max-w">
                    Or {'   '} {' '}
                    <a href="#"
